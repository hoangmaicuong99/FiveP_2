...
namespace FiveP.Controllers.controller3
{
    public class TechnologiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "technology_id,technology_name,technology_datetime,technology_popular,technology_content")] Technology technology)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "technology_id,technology_name,technology_datetime,technology_popular,technology_content")] Technology technology)
        {
            if (ModelState.IsValid)
            {
