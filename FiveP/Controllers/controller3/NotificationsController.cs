...
namespace FiveP.Controllers.controller3
{
    public class NotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "notification_id,post_id,user_id,notification_content,notification_status,notification_datecreate")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "notification_id,post_id,user_id,notification_content,notification_status,notification_datecreate")] Notification notification)
        {
            if (ModelState.IsValid)
            {
